...
REVOKE ALL ON FUNCTION public.quote_line_items_recalculate() FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.quotes_recalculate_on_discount() FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.quotes_before_insert() FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.quotes_before_update() FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.quotes_log_status_change() FROM PUBLIC;
...
REVOKE ALL ON FUNCTION public.quote_line_items_guard() FROM PUBLIC;
