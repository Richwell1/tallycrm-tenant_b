...
REVOKE ALL ON FUNCTION public.recalculate_invoice_payments(UUID) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.recalculate_invoice_payments(UUID) FROM anon;
REVOKE ALL ON FUNCTION public.recalculate_invoice_payments(UUID) FROM authenticated;
