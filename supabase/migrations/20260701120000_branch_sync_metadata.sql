-- Branch/LAN sync metadata.
-- Applies to both cloud Supabase and branch-local Supabase.
...
-- Sync metadata on mutable domain tables. These columns are nullable so the
-- migration is safe for existing production/staging data.
